...
const About = () => {
  return (
    <div style={{ padding: 40, display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 24, maxWidth: 1100, margin: '0 auto' }}>
      <AboutProjectCard
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <QuickStatsCard
          stats={[
            { icon: '🍜', label: 'Favorite anime', value: 'JJK' },
            { icon: '📚', label: 'Hobbies', value: 'Cooking, Reading' },
          ]}
        />
      </div>
    </div>
