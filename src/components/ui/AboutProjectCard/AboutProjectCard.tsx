...
const QuoteBorder = styled('div')({
  display: 'flex',
  paddingLeft: '16px',
  flexDirection: 'column',
  alignItems: 'flex-start',
  alignSelf: 'stretch',
  borderLeft: '4px solid #005BBF',
});
  ...
  return (
    <Card>
      ...
      <ContentSection>
        ...
        <BodyText>{secondParagraph}</BodyText>
      </ContentSection>
      <PillsSection>
        <PillsContainer>
          {pills.map((pill) => (
            <Badge key={pill} variant="pill" label={pill} />
          ))}
        </PillsContainer>
      </PillsSection>
    </Card>
